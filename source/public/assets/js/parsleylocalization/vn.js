...
Parsley.addMessages('vn', {
  defaultMessage: "Giá trị này dường như không hợp lệ.",
  type: {
  ...
  maxcheck: "Bạn phải chọn %s lựa chọn trở xuống.",
  check: "Bạn phải chọn giữa %s và %s lựa chọn.",
  equalto: "Giá trị này phải giống nhau.",
  euvatin: "Đây không phải là Mã số nhận dạng VAT hợp lệ.",
});
